...
public:
	recMacMVU0();
	~recMacMVU0() override { Shutdown(); }

	const char* GetShortName() const override { return "macMVU0"; }
	const char* GetLongName() const override { return "macOS-port microVU0 Recompiler"; }
...
class recMacMVU1 final : public BaseVUmicroCPU
{
public:
	recMacMVU1();
	virtual ~recMacMVU1() { Shutdown(); }

	const char* GetShortName() const override { return "macMVU1"; }
	const char* GetLongName() const override { return "macOS-port microVU1 Recompiler"; }
...
extern recMacMVU0 CpuMicroVU0;
extern recMacMVU1 CpuMicroVU1;

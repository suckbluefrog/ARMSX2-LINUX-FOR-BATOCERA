...
//
// ARM64 EE (R5900) backprop liveness pass. Pure C++ analysis copied from
// x86/iR5900Analysis.cpp since that TU transitively includes
// common/emitter/x86emitter.h via iR5900Analysis.h → iR5900.h and won't
// compile for arm64. Same pattern as iR3000Atables_arm64.cpp duplicating
// the IOP rpsxprop machinery.
//
// Only recBackpropBSC and its dispatch helpers live here; the arm64 path
// does not currently invoke COP2FlagHackPass / COP2MicroFinishPass, so the
// pass classes stay x86-only and we avoid the cop2flags dependency.
